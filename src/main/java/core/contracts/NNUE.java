...
public interface NNUE {
    void updateNnueAccumulator(NNUEState nnueState, long[] bb, int moverPiece, int capturedPiece, int move);
    void undoNnueAccumulatorUpdate(NNUEState nnueState, long[] bb, int moverPiece, int capturedPiece, int move);
