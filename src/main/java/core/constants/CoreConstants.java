...
public final class CoreConstants {
      ...
      /**
         * Margin table for futility pruning, indexed by remaining depth.
         * A move is pruned if static_eval + margin[depth] < alpha.
         * Using a table allows for more aggressive pruning at shallow depths.
         */
      public static final int[] FP_MARGINS = {0, 200, 325, 450, 575, 700, 825, 950}; // Index 0 is unused
}